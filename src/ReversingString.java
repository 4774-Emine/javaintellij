...
public class ReversingString {
    ...
    private static void method11Stack(String str) {//yığın yöntemi
        ...
        int i=0;
        while (!stack.isEmpty()) {
            ch[i++]=stack.pop();//eline aldığı ilk karakteri silerek alır,bu sayede stack azalıyor
    ...
    private static void method4StrBuilder(String str) {
        ...
        System.out.println("String Builder ile "+sb.reverse());
    }
