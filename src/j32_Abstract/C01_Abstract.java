...
public class C01_Abstract {
    /*
    1- Bazı durumlarda child class'lar parent class'daki method'ların genellikle bodylerini değiştirerek override ederler.
    Bu gibi durumlarda parent classtdaki method'a body tanımlamak ram ve memory acısından gereksizdir.
   ...
   ( motor() her aracda olmalı).
    ...
    3- abstract method tanımlamak  için
      ...
      c) abs method içinde abstract keyword ve {} body birarda kullanılamaz aksi halde CTE verir.
