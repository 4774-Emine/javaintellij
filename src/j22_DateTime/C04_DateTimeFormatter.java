...
public class C04_DateTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf=DateTimeFormatter.ofPattern("dd/MMMM/YY");//gün ay ve yıl formatı tanımlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//dtf.format(ldt) = 25/Ekim/22

        DateTimeFormatter dtf1=DateTimeFormatter.ofPattern("hh:mm:ss a ");//saat dakika ve saniye am format tanımlandı
        System.out.println("dtf1.format(ldt) = " + dtf1.format(ldt));//11:25:10 ÖS
